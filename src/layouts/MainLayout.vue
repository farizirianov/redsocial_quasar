  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <q-btn round dense flat color="grey-8" icon="notifications">
            <q-badge color="red" text-color="white" floating> 5
            </q-badge>
    ...
    >
      <q-list>
        ...
        <q-avatar size="120px" font-size="52px" color="primary" text-color="blue" icon="fas fa-address-book" />
        </div>
        <br>
        <EssentialLink
